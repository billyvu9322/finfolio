...
- [x] Action types Mua/Bán/Cổ tức tiền/Cổ tức CP. (FR-STOCK-03)
- [x] **Fee/tax engine** (FR-STOCK-06): default 0.15% buy; 0.15% + 0.1% tax sell; auto-calc from rate; override.
- [x] **WAVG engine** (FR-STOCK-10): weighted-avg cost; stock-dividend adjusts cost basis. Unit-tested.
- [x] **P&L per symbol** (FR-STOCK-11): split capital gain vs dividend received. Unit-tested.
...
- [x] Endpoints: `GET/POST/PUT/DELETE /stocks/transactions`, `GET /stocks/portfolio`, `GET /stocks/prices`, `GET /stocks/:symbol/ohlc` (3-month). Replace stub.
...
- [x] WAVG + fee/tax + P&L match fixtures incl. stock-dividend adjustment. Tests green.
- [x] HOSE qty enforces multiples of 100.
- [x] Sell tax = sell value × 0.1% regardless of P&L.
